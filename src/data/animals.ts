...
export const animals: Animal[] = [
  {
    ...
    details: {
      intro:
        "The lion has been admired for centuries as a symbol of courage, strength, and nobility. Living in social groups called prides, these magnificent predators roam the grasslands of Africa, their powerful roars echoing across the plains.",
      social:
        "Lions live in groups called prides, typically consisting of 5-15 individuals. Females do most of the hunting and cub rearing, while males defend the territory.",
      hunting:
        "Lions are apex predators with incredible hunting skills. They work together in coordinated attacks, with lionesses using stealth and teamwork.",
      ...
      habitat_info:
        "Lions primarily inhabit the savannas and grasslands of Africa, though they can also be found in dense bush and open woodlands. Historically, their range extended across much of Europe, Africa, and Asia.",
    ...
    color: "#C69C6D",
    externalLinks: [
      { label: "Wikipedia - Lion", url: "https://en.wikipedia.org/wiki/Lion" },
      {
      ...
      },
      {
        ...
        url: "https://www.nationalgeographic.com/animals/mammals/facts/lion",
      },
    ],
  },
  {
    ...
    details: {
      intro:
        "Solitary and elusive, the leopard is the most graceful and secretive of the big cats. Masters of camouflage, they can blend perfectly into their surroundings.",
      social:
        "Leopards are strictly solitary animals. They only come together to mate. Males and females have separate territories.",
      hunting:
        "Leopards are ambush predators. They rely on stealth to get within striking distance of their prey before pouncing.",
      ...
      habitat_info:
        "Leopards are highly adaptable and can live in diverse habitats ranging from rainforests and savannas to deserts and mountains. They are found across Africa and parts of Asia.",
      conservation_status: "Vulnerable",
      fun_facts: [
  ...
  },
  {
    ...
    details: {
      intro:
        "Rhinoceroses are large, herbivorous mammals identified by their horned snouts. They are some of the largest remaining megafauna.",
      social:
        "Rhinos can be solitary or social depending on the species. White rhinos are the most social.",
      hunting:
        "Rhinos are herbivores, but they are fierce defenders. They will charge at any perceived threat.",
      ...
      habitat_info:
        "Rhinos can be found in savannas, dense forests, and tropical bushlands. Their habitat varies by species, with White rhinos preferring open grasslands and Black rhinos preferring dense bush.",
    ...
    externalLinks: [
      {
        label: "Wikipedia - Rhinoceros",
        url: "https://en.wikipedia.org/wiki/Rhinoceros",
      },
      { label: "Save the Rhino", url: "https://www.savetherhino.org/" },
      {
        label: "WWF - Rhino",
  ...
  },
  {
    ...
    details: {
      intro:
        "African elephants are the largest land animals on Earth. They are highly intelligent and have complex emotions.",
      social:
        "Elephants live in matriarchal herds led by the oldest female. They have deep family bonds.",
      hunting:
        "Elephants are herbivores. They spend up to 16 hours a day eating.",
      ...
      habitat_info:
        "African elephants inhabit a diverse range of habitats, including savannas, forests, deserts, and marshes. They are a keystone species, shaping their environment by pushing over trees and digging for water.",
    ...
    externalLinks: [
      {
        label: "Wikipedia - African Elephant",
        url: "https://en.wikipedia.org/wiki/African_elephant",
      },
      {
        label: "African Wildlife Foundation",
        url: "https://www.awf.org/wildlife-conservation/elephant",
      },
      {
        label: "Sheldrick Wildlife Trust",
        url: "https://www.sheldrickwildlifetrust.org/",
      },
    ],
  },
  {
    ...
    details: {
      intro:
        "The Cape Buffalo is known for its unpredictable nature and is considered one of the most dangerous animals in Africa.",
      social:
        "Buffalo live in large herds which can number in the thousands. This provides protection against predators.",
      hunting:
        "Buffalo are herbivores, grazers who need lots of water. They are formidable when cornered.",
      ...
      habitat_info:
        "They are found in swamps, floodplains, mopane grasslands, and forests of the major mountains of Africa. They avoid open areas without cover and need plenty of water.",
    ...
    externalLinks: [
      {
        label: "Wikipedia - African Buffalo",
